...
class Thread {
  ...
  public:
    ...
    //The following codes are designed to be used for CPU scheduling.
    //Some thread-related values that I need for CPU scheduling.
    int start_time_of_the_thread;
    int priority_of_the_thread;
    int predicted_burst_time_of_the_thread;


    //Some functions that I need for setting some thread-related values.
    void set_start_time(int start_time_);
    void set_priority(int priority_);
    void set_predicted_burst_time(int predicted_burst_time_);


    static void testing_function_1();
    static void testing_function_2();
