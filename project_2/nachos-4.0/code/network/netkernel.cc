...
void
NetKernel::Initialize(SchedulerType ty)
{
    UserProgKernel::Initialize(ty);	// init other kernel data structs
...
void
NetKernel::SelfTest(bool var1, bool var2) {
    UserProgKernel::SelfTest(var1, var2);		// this requires each nachos
